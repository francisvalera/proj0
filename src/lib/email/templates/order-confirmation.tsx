...
function getStoreName() {
  // Prefer NEXT_PUBLIC_STORE_NAME; fallback to the display name in EMAIL_FROM or a default string
    ...
    <Html>
      <Body style={{ backgroundColor: "#ffffff" }}>
        <Container style={{ border: "1px solid #e5e7eb", padding: 16 }}>
          <Text style={{ fontSize: 20, fontWeight: 700, marginBottom: 4 }}>Your Order Receipt</Text>
