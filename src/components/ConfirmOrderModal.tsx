      ...
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-sm w-full">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            onClick={onConfirm}
            disabled={isPlacingOrder}
            className="px-4 py-2 rounded-md text-white bg-red-600 hover:bg-red-700 flex items-center justify-center disabled:opacity-50"
          >
            {isPlacingOrder ? (
              <>
                <LoadingSpinner className="w-4 h-4 mr-2" /> Processing...
              </>
            ) : (
              "Confirm"
            )}
