...
// type Sort<T extends object> = { key: keyof T; dir: "asc" | "desc" };
...
//   const getComparable = (v: unknown): string | number => {
//     if (v == null) return "";
//     if (typeof v === "number") return v;
//     if (v instanceof Date) return v.getTime();
//     return String(v);
...
//           onChange={(e) => setQ(e.target.value)}
//           placeholder="Search..."
//           className="w-full md:w-80 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm outline-none focus:ring-2 focus:ring-slate-200"
//         />
//       </div>
...
//                 <th
//                   key={String(c.key)}
//                   className="text-left px-3 py-2 font-medium text-neutral-600"
//                 >
//                   <button
//                     className={`inline-flex items-center gap-1 ${
//                       c.sortable ? "hover:underline" : "cursor-default"
